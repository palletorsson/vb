...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'orders_orderitem', 'order_id')

        # Adding field 'OrderItem.checkout'
        db.add_column(u'orders_orderitem', 'checkout',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['checkout.Checkout']),
                      keep_default=False)

        # Deleting field 'ReaOrderItem.order'
        db.delete_column(u'orders_reaorderitem', 'order_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'orders_orderitem', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orders.Order']),
                      keep_default=False)

        # Deleting field 'OrderItem.checkout'
        db.delete_column(u'orders_orderitem', 'checkout_id')

        # Adding field 'ReaOrderItem.order'
        db.add_column(u'orders_reaorderitem', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['orders.Order']),
                      keep_default=False)
