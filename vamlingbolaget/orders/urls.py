...
urlpatterns = patterns('orders.views',
    ...
    url(r'ordersByName/(?P<name>[a-zA-Z0-9_.-]+)/$', 'ShowOrdersByName'),
    url(r'order/(?P<order_id>[a-zA-Z0-9_.-]+)/$', 'ShowOrder'),
    url(r'order/action/(?P<todo>[a-zA-Z0-9_.-]+)/(?P<stage>[a-zA-Z0-9_.-]+)/(?P<order_number>[a-zA-Z0-9_.-]+)/(?P<send_type>[a-zA-Z0-9_.-]+)/(?P<weight>[a-zA-Z0-9_.-]+)/$', 'OrderAction'),
