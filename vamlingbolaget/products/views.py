...
def cutondemandApi(request, category): 
    ...
    children = Variation.objects.filter(article__category__slug='barn', article__category__slug='accessoarer', order__lte=100, active=True).order_by('order', 'article__quality')
