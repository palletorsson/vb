...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bargainbox.description'
        db.alter_column('products_bargainbox', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Bargainbox.description'
        db.alter_column('products_bargainbox', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))
