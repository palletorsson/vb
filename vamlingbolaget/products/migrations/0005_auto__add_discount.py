...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('products_discount', (
        ...
        db.send_create_signal('products', ['Discount'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('products_discount')
    ...
    models = {
        ...
        'products.discount': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['products.Article']", 'symmetrical': 'False'}),
