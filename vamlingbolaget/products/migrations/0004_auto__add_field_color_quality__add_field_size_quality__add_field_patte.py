...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Color.quality'
        db.add_column('products_color', 'quality',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['products.Quality']),
                      keep_default=False)

        # Adding field 'Size.quality'
        db.add_column('products_size', 'quality',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['products.Quality']),
                      keep_default=False)

        # Adding field 'Pattern.quality'
        db.add_column('products_pattern', 'quality',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['products.Quality']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Color.quality'
        db.delete_column('products_color', 'quality_id')

        # Deleting field 'Size.quality'
        db.delete_column('products_size', 'quality_id')

        # Deleting field 'Pattern.quality'
        db.delete_column('products_pattern', 'quality_id')
