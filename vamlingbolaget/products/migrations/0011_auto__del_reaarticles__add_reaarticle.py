...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ReaArticles'
        db.delete_table('products_reaarticles')

        # Adding model 'ReaArticle'
        db.create_table('products_reaarticle', (
            ...
            ('rea_price', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('stockquantity', self.gf('django.db.models.fields.IntegerField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('products', ['ReaArticle'])


    def backwards(self, orm):
        # Adding model 'ReaArticles'
        db.create_table('products_reaarticles', (
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Category'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal('products', ['ReaArticles'])

        # Deleting model 'ReaArticle'
        db.delete_table('products_reaarticle')
    ...
    models = {
        ...
        'products.patternandcolor': {
            'Meta': {'ordering': "['-color', '-pattern']", 'object_name': 'PatternAndColor'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
