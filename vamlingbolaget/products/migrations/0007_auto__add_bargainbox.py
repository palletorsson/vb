...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Bargainbox'
        db.create_table('products_bargainbox', (
        ...
        db.send_create_signal('products', ['Bargainbox'])


    def backwards(self, orm):
        # Deleting model 'Bargainbox'
        db.delete_table('products_bargainbox')
