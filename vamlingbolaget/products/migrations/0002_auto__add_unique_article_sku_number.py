...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Article', fields ['sku_number']
        db.create_unique('products_article', ['sku_number'])


    def backwards(self, orm):
        # Removing unique constraint on 'Article', fields ['sku_number']
        db.delete_unique('products_article', ['sku_number'])
