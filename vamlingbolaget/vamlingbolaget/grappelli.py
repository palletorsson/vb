...
VERSIONS = getattr(settings, "FILEBROWSER_VERSIONS", {
    ...
    'medium': {'verbose_name': 'Medium (4col )', 'width': 400, 'height': '', 'opts': ''},
    'big': {'verbose_name': 'Big (6 col)', 'width': 640, 'height': '', 'opts': ''},
    'large': {'verbose_name': 'Large (8 col)', 'width': 800, 'height': '', 'opts': ''},
    })
