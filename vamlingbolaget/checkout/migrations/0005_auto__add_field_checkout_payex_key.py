...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Checkout.payex_key'
        db.add_column('checkout_checkout', 'payex_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Checkout.payex_key'
        db.delete_column('checkout_checkout', 'payex_key')
    ...
    models = {
        'checkout.checkout': {
            ...
            'payex_key': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
