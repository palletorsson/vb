...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_image', 'photographer',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Image.order'
        db.add_column('gallery_image', 'order',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Image.name_sv'
        db.alter_column('gallery_image', 'name_sv', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Image.name'
        db.alter_column('gallery_image', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Image.name_en'
        db.alter_column('gallery_image', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Image.photographer'
        db.delete_column('gallery_image', 'photographer')

        # Deleting field 'Image.order'
        db.delete_column('gallery_image', 'order')


        # Changing field 'Image.name_sv'
        db.alter_column('gallery_image', 'name_sv', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Image.name'
        db.alter_column('gallery_image', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Image.name_en'
        db.alter_column('gallery_image', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    models = {
        'flatpages.flatpage': {
            ...
            'content_sv': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'gallery.image': {
            ...
            'name_en': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'name_sv': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'photographer': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
