...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Image.photographer' to match new field type.
        db.rename_column('gallery_image', 'photographer', 'photographer_id')
        # Changing field 'Image.photographer'
        db.alter_column('gallery_image', 'photographer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Photographer'], null=True))
        # Adding index on 'Image', fields ['photographer']
        db.create_index('gallery_image', ['photographer_id'])


    def backwards(self, orm):
        # Removing index on 'Image', fields ['photographer']
        db.delete_index('gallery_image', ['photographer_id'])
        ...
        # Renaming column for 'Image.photographer' to match new field type.
        db.rename_column('gallery_image', 'photographer_id', 'photographer')
        # Changing field 'Image.photographer'
        db.alter_column('gallery_image', 'photographer', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
